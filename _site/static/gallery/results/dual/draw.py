...
def image_list_1(path):
    image1 = os.path.join(path, '1-1.jpg')
    image2 = os.path.join(path, '1-2.jpg')
    image3 = os.path.join(path, '1-3.jpg')
    image4 = os.path.join(path, '1-4.jpg')
    image5 = os.path.join(path, '1-5.jpg')
    image6 = os.path.join(path, '1-6.jpg')
    image7 = os.path.join(path, '1-7.jpg')
    image8 = os.path.join(path, '1-8.jpg')
    image9 = os.path.join(path, '1-9.jpg')
    image10 = os.path.join(path, '1-10.jpg')
...
basic_path = "D:\WZY\My_paper\AAAI2025\图\qualitative\qualitative"
...
save_image(img_1, fp=os.path.join(basic_path, "qualitative_1.jpg"), nrow=3, padding=0,pad_value=1)
